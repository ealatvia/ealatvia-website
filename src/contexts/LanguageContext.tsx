...
const translations = {
  lv: {
    ...
    'faq.a16': 'Daudzi cilvēki ideju panākt maksimāli daudz laba uzskata par diezgan pašsaprotamu. Taču vairums cilvēku to neuztver par pietiekami pašsaprotamu, lai apzināti vadīties pēc tā, kas pēc aplēsēm panāks lielāko labumu. Kā liecina efektīvo organizāciju saņemtais ziedojumu apjoms, vairākums cilvēku izlemj būtiski nepūlēties palīdzēt citiem vai arī izvēlas labdarības organizācijas, neveicot nopietnu izpēti un nesalīdzinot dažādas opcijas.',
  ...
  en: {
    ...
    'faq.q16': 'Isn\'t effective altruism just common sense?',
